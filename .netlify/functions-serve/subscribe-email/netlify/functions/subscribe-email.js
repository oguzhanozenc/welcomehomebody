...
var subscribe_email_exports = {};
__export(subscribe_email_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(subscribe_email_exports);
...
async function handler(event, context) {
  ...
  const audienceId = "5c9b0afd36";
  const serverPrefix = "us13";
  const apiUrl = `https://${serverPrefix}.api.mailchimp.com/3.0/lists/${audienceId}/members`;
  console.log(`Received a submission: ${email}`);
  console.log(`Mailchimp API URL: ${apiUrl}`);
...
*/
//# sourceMappingURL=subscribe-email.js.map
