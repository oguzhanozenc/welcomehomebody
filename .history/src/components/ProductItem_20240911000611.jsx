  ...
  const handleAddToCartClick = async () => {
    ...
    if (selectedVariant && selectedVariant.availableForSale) {
      ...
      try {
        ...
        setButtonState("Bagged!"); // Success state
      } catch (error) {
        console.error("Failed to add to cart:", error);
        alert("Failed to add item to cart. Please try again."); // Display the alert only on error
  ...
  const handleRemoveFromCartClick = async () => {
    if (selectedVariant) {
      ...
      try {
        ...
        setButtonState("BAG IT"); // Reset to default state after success
      } catch (error) {
        console.error("Failed to remove from cart:", error);
        alert("Failed to remove item from cart. Please try again.");
        setButtonState("BAG IT"); // Reset state after failure
      }
    } else {
