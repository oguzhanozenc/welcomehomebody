...
const ReviewCart = () => {
  ...
  useEffect(() => {
    console.log("Cart items in ReviewCart component:", cartItems); // Log cart items
  }, [cartItems]);
  ...
  const handleRemoveItem = async (variantId) => {
    console.log("Attempting to remove item with Variant ID:", variantId); // Log before removing
    try {
  ...
  const handleUpdateQuantity = async (variantId, quantity) => {
    console.log(
      `Updating quantity for Variant ID: ${variantId} to ${quantity}`
    ); // Log quantity update
