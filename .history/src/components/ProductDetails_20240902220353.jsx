...
const ProductDetails = () => {
  ...
  const { handleAddToCart, handleRemoveFromCart } = useShopifyCart(); // Importing handleRemoveFromCart as well
  ...
  return (
    <div className="product-details-container">
      <ProductItem
        ...
        handleRemoveFromCart={handleRemoveFromCart} // Passing down handleRemoveFromCart
        slider={slider}
      />
    </div>
  );
